...
>> I've switched to using Sublime with the Anaconda Python IDE. It's fast and easy to use, and I prefer the style and syntax formatting of Sublime to Spyder. I enjoy the code completion and linting. You can also easily access docstrings by hovering the cursor over items. A useful keyboard shortcut is ctrl+b which runs your script in the shell, and ctrl+tab which switches between open files. In addition to costumizing Sublime with the Anaconda IDE, I changed a few other preferences including color scheme and added a ruler.  
